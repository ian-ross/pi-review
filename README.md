...
saves the current model before starting the review, switches to the configured
review model on the review branch, then restores the saved model before returning
or queuing fix work.
